...
/**
 * Event_Mods 
 * Modifications to Event Calendar/Community plugins, adds and alters
 * routes for custom promoter type.
 * 
 *
 * @package Events_Mods
 *
...
class Events_Mods {
	...
	/**
	 * Filter messages and replace the word Organizer with Promoter
	 */
	...
	/**
	 * Enqueue the event_mods.js for Country selector
	 */
	...
	/**
	 * Add routes for adding promoter listing.
	 */	
	public function add_promoter_listing( $router ) {
		...
		//Mod the path showing 'promoter' in the url
	...
	/**
	 * Callback to list the promoters belonging to user
	 */		
	public function list_promoters_callback() {
		...
		//Send promoters results to the template for rendering
		tribe_get_template_part( 'community/promoter', 'list', array( 'promoters' => $promoters ) );

	}

	/**
	 * Alter routes for editing promoters and venues
	 */		
